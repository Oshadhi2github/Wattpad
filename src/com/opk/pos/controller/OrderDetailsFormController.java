...
import com.opk.pos.view.tm.ItemDetailsTM;
...
public class OrderDetailsFormController {
    ...
    public void loadData(String orderId){
       ...
       Order o= Database.orderTable.stream().filter(e->e.getOrderId().equals(orderId)).findFirst().orElse(null);

        if (o!=null){

            Customer c= Database.customerTable.stream().filter(e->e.getId().equals(o.getCustomer())).findFirst().orElse(null);
            ...
            if (c!=null){
                ...
                for (CartItem item: o.getItems()
                    ...
                    tmList.add(new ItemDetailsTM(item.getCode(),item.getUnitPrice(),item.getQty(),(item.getQty())*item.getUnitPrice()));
                }
